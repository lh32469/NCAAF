...
import org.gpc4j.ncaaf.GameComparator;
 ...
 */
public class RedisGamesProvider implements GamesProvider {
    ...
    public RedisGamesProvider(JedisPool pool) {
        this.pool = pool;
        load();
    }
    ...
    @Override public Stream<Game> getGames() {
     ...
     */
    @Override public Stream<Game> playedByYear(Integer year) {
     ...
     */
    @Override public Stream<Game> byYear(Integer year) {
    ...
    @Override public Stream<Game> byTeam(String teamName) {
    ...
    @Override public Optional<Game> getGame(Team team, Integer year, int week) {
    ...
    @Override public Game lastGameOfYear(String teamName, Integer year) {
     ...
     */
    @Override public Optional<Game> gameWithNoDate(String teamName, Integer keyYear) {
    ...
    @Override public Stream<Game> byTeamAndYear(String teamName, Integer year) {
     ...
     */
    @Override public Stream<Game> gamesPlayed(String teamName, Integer year) {
    ...
    @Override public Optional<Game> getNextGame(String teamName, int year) {
